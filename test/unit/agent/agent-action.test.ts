...
const clickSubmitFixture = JSON.parse(
  readFileSync(resolve(process.cwd(), "test/fixtures/agent-action-click-submit.json"), "utf-8")
);
...
const typePanFixture = JSON.parse(
  readFileSync(resolve(process.cwd(), "test/fixtures/agent-action-type-pan.json"), "utf-8")
);
